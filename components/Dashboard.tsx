                    ...
                    <div className="flex items-center gap-3">
                      ...
                      {job.targetSpreadsheetId && (
                        <a 
                          ...
                          className="text-xs font-bold bg-white/10 hover:bg-white/20 text-blue-200 border border-white/10 px-3 py-1.5 rounded-lg transition-colors flex items-center gap-1"
                          title="Open Google Sheet"
                        >
                          OPEN <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                        </a>
                      )}
                    </div>
                  </div>
